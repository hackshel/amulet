...
int smap_traverse(struct SMAP *, smap_callback *, unsigned int);
int smap_traverse_num(struct SMAP *, smap_callback *, unsigned int);
int smap_traverse_str(struct SMAP *, smap_callback *, unsigned int);
